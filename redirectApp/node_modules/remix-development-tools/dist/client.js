...
var useRemixForgeSocket = (options) => {
  return { sendJsonMessage: (obj) => {
  }, isConnected: false, isConnecting: false };
};
var useRemixForgeSocketExternal = (options) => {
  const { sendJsonMessage, ...rest } = useRemixForgeSocket(options);
  const sendJsonMessageExternal = (message) => {
...
function useBorderedRoutes() {
  ...
  const traverseComponentTree = useCallback2((fiberNode, callback) => {
    callback(fiberNode);
  ...
  const findIncorrectHtml = useCallback2((fiberNode, originalFiberNode, originalTag) => {
    if (!fiberNode)
      return;
...
import { useActionData, useFetchers, useNavigation as useNavigation2 } from "@remix-run/react";
...
import { useEffect as useEffect16, useMemo as useMemo5 } from "react";
...
import { useMatches as useMatches2, useRevalidator } from "@remix-run/react";
...
var useCountdown = (targetDate) => {
  ...
  const [countDown, setCountDown] = useState2(countDownDate - (/* @__PURE__ */ new Date()).getTime());
  useEffect9(() => {
...
var Tag = ({ color, children, className }) => {
  return /* @__PURE__ */ jsx4("span", { className: clsx2("flex items-center rounded px-2.5 py-0.5 text-sm font-medium", className, TAG_COLORS[color]), children });
};
...
var InfoCard = ({
  ...
  return /* @__PURE__ */ jsxs5("div", { className: "mb-4 h-min rounded-lg border-solid border-gray-500/40 text-base font-normal text-white transition-all", children: [
    /* @__PURE__ */ jsxs5(
      "h3",
      {
        className: clsx4(
        ...
        children: [
          title,
          onClear && typeof import.meta.hot === "undefined" && /* @__PURE__ */ jsx5(
            "button",
            {
              type: "button",
              onClick: onClear,
...
import { createContext as createContext7, useContext as useContext7, useEffect as useEffect10, useReducer as useReducer7 } from "react";
...
var TypeString = ({ children = "", expandKey, keyName }) => {
  ...
  return /* @__PURE__ */ jsxs6(Fragment2, { children: [
    ...
    child || /* @__PURE__ */ jsxs6(Fragment2, { children: [
...
var TypeUrl = ({ children, expandKey, keyName }) => {
  ...
  return /* @__PURE__ */ jsxs6(Fragment2, { children: [
    displayDataTypes && (type || /* @__PURE__ */ jsx16(Comp, { ...reset, style })),
    child || /* @__PURE__ */ jsxs6("a", { href: children?.href, target: "_blank", ...reset, className: "w-rjv-value", children: [
      /* @__PURE__ */ jsx16(ValueQuote, {}),
      children?.href,
      /* @__PURE__ */ jsx16(ValueQuote, {})
    ] }),
...
var KayName = (props) => {
  ...
  return /* @__PURE__ */ jsxs7(Fragment3, { children: [
    /* @__PURE__ */ jsxs7("span", { ref: highlightContainer, children: [
...
var KeyValuesItem = (props) => {
  ...
  return /* @__PURE__ */ jsxs7("div", { className: "w-rjv-line", ...reset, children: [
...
var NestedOpen = (props) => {
  ...
  return /* @__PURE__ */ jsxs8("span", { ...reset, children: [
...
var Container = forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsxs9("div", { className: defaultClassNames, ref, ...elmProps, ...reset, children: [
...
var JsonRenderer = ({ data }) => {
  ...
  return /* @__PURE__ */ jsx26(react_json_view_default, { highlightUpdates: true, style: customTheme, collapsed: settings.expansionLevel, value: json });
};
      ...
      children: [
        /* @__PURE__ */ jsx27(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsx27(Icon, { name: isRoot ? "Root" : isLayout ? "Layout" : "CornerDownRight", size: "sm" })
          }
        ),
        /* @__PURE__ */ jsxs11("h2", { className: "text-md -mt-3 mb-1 text-white flex items-center justify-between gap-2 font-semibold text-white", children: [
          route.pathname,
          /* @__PURE__ */ jsxs11("div", { className: "flex gap-2", children: [
            cacheControl && serverInfo?.lastLoader.timestamp && /* @__PURE__ */ jsx27(
              CacheInfo,
              {
                cacheControl,
            ...
            /* @__PURE__ */ jsxs11("div", { className: "flex items-center gap-2", children: [
              isConnected && import.meta.env.DEV && /* @__PURE__ */ jsx27(
                EditorButton,
                {
                  name: editorName,
                  onClick: () => sendJsonMessage({
              ...
              settings.showRouteBoundariesOn === "click" && /* @__PURE__ */ jsx27(
                "button",
                {
                  type: "button",
        ...
        /* @__PURE__ */ jsxs11("div", { className: "mb-4", children: [
          /* @__PURE__ */ jsxs11("p", { className: "mb-2 block text-sm font-normal leading-none text-gray-500  ", children: [
            "Route segment file: ",
            route.id
          ] }),
          /* @__PURE__ */ jsxs11("div", { className: "flex flex-wrap gap-6", children: [
            loaderData && /* @__PURE__ */ jsx27(InfoCard, { title: "Returned loader data", children: /* @__PURE__ */ jsx27(JsonRenderer, { data: loaderData }) }),
            serverInfo && import.meta.env.DEV && /* @__PURE__ */ jsx27(InfoCard, { onClear: clearServerInfoForRoute, title: "Server information", children: /* @__PURE__ */ jsx27(JsonRenderer, { data: cleanServerInfo(serverInfo) }) }),
            route.params && Object.keys(route.params).length > 0 && /* @__PURE__ */ jsx27(InfoCard, { title: "Route params", children: /* @__PURE__ */ jsx27(JsonRenderer, { data: route.params }) }),
            Boolean(route.handle && Object.keys(route.handle).length > 0) && /* @__PURE__ */ jsx27(InfoCard, { title: "Route handle", children: /* @__PURE__ */ jsx27(JsonRenderer, { data: route.handle }) })
          ] })
        ] })
      ]
    }
...
var PageTab = () => {
  ...
  return /* @__PURE__ */ jsxs12(Fragment4, { children: [
    /* @__PURE__ */ jsxs12("div", { className: "sticky w-full top-0 z-30 mb-2 bg-[#212121] pt-2", children: [
      /* @__PURE__ */ jsxs12("div", { className: "mb-1 flex justify-between ", children: [
        /* @__PURE__ */ jsx28("div", { className: "text-lg font-semibold", children: "Active Route Segments" }),
        /* @__PURE__ */ jsx28(
          "button",
          {
            type: "button",
      ...
      /* @__PURE__ */ jsx28("hr", { className: "border-gray-700" })
    ] }),
    /* @__PURE__ */ jsx28("div", { className: "relative flex h-full flex-col p-6 px-2 pl-4 lg:px-6", children: /* @__PURE__ */ jsx28(
      "ol",
      {
        className: clsx6("relative border-l border-gray-700", state === "loading" && "pointer-events-none opacity-50"),
        children: reversed.map((route, i) => /* @__PURE__ */ jsx28(RouteSegmentInfo, { route, i }, route.id))
      }
    ) })
  ] });
};
...
import { useMatches as useMatches3, useNavigate as useNavigate2 } from "@remix-run/react";
...
var AccordionItem = React4.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx29(AccordionPrimitive.Item, { ref, className: cn("border-b border-b-gray-500", className), ...props }));
AccordionItem.displayName = "AccordionItem";
var AccordionTrigger = React4.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx29(AccordionPrimitive.Header, { className: "flex", children: /* @__PURE__ */ jsxs13(
  AccordionPrimitive.Trigger,
  {
    ...
    children: [
      children,
      /* @__PURE__ */ jsx29(Icon, { className: "text-white h-4 w-4 shrink-0 transition-transform duration-200", name: "ChevronDown" })
    ]
  }
) }));
AccordionTrigger.displayName = AccordionPrimitive.Trigger.displayName;
var AccordionContent = React4.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsx29(
  AccordionPrimitive.Content,
  {
    ...
    ...props,
    children: /* @__PURE__ */ jsx29("div", { className: "pt-0", children })
  }
));
...
var Checkbox = ({ onChange, id, children, value, hint, ...props }) => {
  return /* @__PURE__ */ jsxs14("div", { children: [
    /* @__PURE__ */ jsxs14("div", { className: "flex items-center gap-2 py-1", children: [
      /* @__PURE__ */ jsx30(
        "input",
        {
      ...
      /* @__PURE__ */ jsx30("label", { className: "text-md cursor-pointer", htmlFor: id, children })
    ] }),
    hint && /* @__PURE__ */ jsx30("p", { className: "text-sm text-gray-500", children: hint })
  ] });
};
...
var Label = ({ className, children, ...props }) => {
  return /* @__PURE__ */ jsx31("label", { htmlFor: props.name, className: clsx7("block text-white text-sm", className), ...props, children });
};
var Hint = ({ children }) => {
  return /* @__PURE__ */ jsx31("p", { className: "text-sm text-gray-500", children });
};
var Input = ({ className, name, label, hint, ...props }) => {
  return /* @__PURE__ */ jsxs15("div", { className: "flex w-full flex-col gap-1", children: [
    label && /* @__PURE__ */ jsx31(Label, { htmlFor: name, children: label }),
    /* @__PURE__ */ jsx31(
      "input",
      {
        name,
    ...
    hint && /* @__PURE__ */ jsx31(Hint, { children: hint })
  ] });
};
...
var NewRouteForm = () => {
  ...
  const [newRouteInfo, setNewRouteInfo] = useState6(DEFAULT_VALUES);
  const handleSubmit = () => {
  ...
  return /* @__PURE__ */ jsxs16("div", { className: "mb-2 rounded-lg border border-gray-500/20 p-2", children: [
    /* @__PURE__ */ jsx32("div", { className: "mb-2 block ", children: "Route path:" }),
    /* @__PURE__ */ jsx32(
      Input,
      {
        onBlur: () => setNewInfo({
    ...
    /* @__PURE__ */ jsx32("span", { className: "mb-4 block text-gray-500", children: "This will be added to your routes folder under your entered name, exclude the extension" }),
    /* @__PURE__ */ jsx32("div", { className: "mb-2 block", children: "Additional options:" }),
    /* @__PURE__ */ jsx32(
      Checkbox,
      {
    ...
    /* @__PURE__ */ jsx32(Checkbox, { value: newRouteInfo.meta, onChange: () => setNewInfo({ meta: !newRouteInfo.meta }), id: "meta", children: "Add a meta export" }),
    /* @__PURE__ */ jsx32(Checkbox, { value: newRouteInfo.links, onChange: () => setNewInfo({ links: !newRouteInfo.links }), id: "links", children: "Add a links export" }),
    /* @__PURE__ */ jsx32(
      Checkbox,
      {
...
import { useLocation, useNavigate, useNavigation as useNavigation4 } from "@remix-run/react";
...
var useListenToRouteChange = () => {
  ...
  const ref = useRef7(locationRoute);
...
var RouteInfo = ({ route, className, openNewRoute, onClose }) => {
  ...
  return /* @__PURE__ */ jsxs17("div", { className: clsx9(className, "relative"), children: [
    isTreeView && /* @__PURE__ */ jsxs17(Fragment5, { children: [
      /* @__PURE__ */ jsx33(Icon, { onClick: onClose, className: "absolute right-2 top-2 cursor-pointer text-red-600", name: "X" }),
      /* @__PURE__ */ jsx33("h1", { className: "text-xl font-semibold", children: route.url }),
      /* @__PURE__ */ jsx33("hr", { className: "mb-4 mt-1" }),
      /* @__PURE__ */ jsxs17("h3", { children: [
        /* @__PURE__ */ jsx33("span", { className: "text-gray-500", children: "Path:" }),
        " ",
        path
      ] }),
      /* @__PURE__ */ jsxs17("h3", { children: [
        /* @__PURE__ */ jsx33("span", { className: "text-gray-500", children: "Url:" }),
        " ",
        pathToOpen
      ] })
    ] }),
    /* @__PURE__ */ jsxs17("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsx33("span", { className: "whitespace-nowrap text-gray-500", children: "Route file:" }),
      route.id
    ] }),
    /* @__PURE__ */ jsxs17("div", { className: "mb-4 mt-4 flex flex-col gap-2", children: [
      /* @__PURE__ */ jsx33("span", { className: "text-gray-500", children: "Components contained in the route:" }),
      /* @__PURE__ */ jsxs17("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsx33(Tag, { className: "h-max", color: route.hasLoader ? "GREEN" : "RED", children: "Loader" }),
        /* @__PURE__ */ jsx33(Tag, { className: "h-max", color: route.hasAction ? "GREEN" : "RED", children: "Action" }),
        /* @__PURE__ */ jsx33(
          Tag,
          {
      ...
      hasErrorBoundary ? /* @__PURE__ */ jsx33("div", { className: "mr-2", children: hasParentErrorBoundary ? `Covered by parent ErrorBoundary located in: ${route.errorBoundary.errorBoundaryId}` : "" }) : null
    ] }),
    hasWildcard && /* @__PURE__ */ jsxs17(Fragment5, { children: [
      /* @__PURE__ */ jsx33("p", { className: "mb-2 text-gray-500", children: "Wildcard parameters:" }),
      /* @__PURE__ */ jsx33("div", { className: clsx9("mb-4 grid w-full grid-cols-2 gap-2", isTreeView && "grid-cols-1"), children: route.url.split("/").filter((p) => p.startsWith(":")).map((param) => /* @__PURE__ */ jsxs17("div", { className: "flex w-full gap-2", children: [
        /* @__PURE__ */ jsx33(Tag, { color: "BLUE", children: param }, param),
        /* @__PURE__ */ jsx33(
          Input,
          {
...
var RouteNode = ({
  ...
  return /* @__PURE__ */ jsxs18("g", { className: "flex", children: [
    /* @__PURE__ */ jsx34(
      "circle",
      {
        x: 20,
    ...
    /* @__PURE__ */ jsx34("g", { children: /* @__PURE__ */ jsx34("foreignObject", { y: -15, x: 17, width: 110, height: 140, children: /* @__PURE__ */ jsx34(
      "p",
      {
...
var RouteToggle = () => {
  ...
  return /* @__PURE__ */ jsxs19("div", { className: "absolute left-0 top-0 flex items-center gap-2 rounded-lg border border-white px-3 py-1", children: [
    /* @__PURE__ */ jsx35(
      Icon,
      {
...
var RoutesTab = () => {
  ...
  const { detachedWindow } = useDetachedWindowControls();
  const [activeRoute, setActiveRoute] = useState7(null);
  const [routes] = useState7(createExtendedRoutes());
  const [treeRoutes] = useState7(createRouteTree(window.__remixManifest.routes));
  const isTreeView = routeViewMode === "tree";
  ...
  return /* @__PURE__ */ jsxs20("div", { className: clsx12("relative h-full w-full ", !isTreeView && "pt-8"), children: [
    /* @__PURE__ */ jsx36(RouteToggle, {}),
    isTreeView ? /* @__PURE__ */ jsxs20("div", { className: "flex h-full w-full", children: [
      /* @__PURE__ */ jsx36(
        Tree,
        {
    ...
    ] }) : /* @__PURE__ */ jsxs20(Accordion, { className: "h-full w-full overflow-y-auto pr-4", type: "single", collapsible: true, children: [
      isConnected && /* @__PURE__ */ jsxs20(AccordionItem, { value: "add-new", children: [
        /* @__PURE__ */ jsx36(AccordionTrigger, { className: "text-white", children: "Add a new route to the project" }),
        /* @__PURE__ */ jsx36(AccordionContent, { children: /* @__PURE__ */ jsx36(NewRouteForm, {}) })
      ] }),
      /* @__PURE__ */ jsxs20("div", { className: "py-2", children: [
        /* @__PURE__ */ jsx36("span", { className: "text-lg font-semibold", children: "Project routes" }),
        /* @__PURE__ */ jsx36("hr", { className: "mt-2 border-gray-400" })
      ] }),
      routes?.map((route) => {
        const { path, pathToOpen } = constructRoutePath(route, routeWildcards);
        return /* @__PURE__ */ jsxs20(AccordionItem, { value: route.id, children: [
          /* @__PURE__ */ jsx36(AccordionTrigger, { children: /* @__PURE__ */ jsxs20("div", { className: "justify-center flex-wrap text-white flex px-3 lg:px-0 flex-col lg:flex-row w-full items-start lg:items-center gap-1 ", children: [
            /* @__PURE__ */ jsx36("span", { className: "text-gray-500" }),
            " ",
            route.url,
            " ",
            /* @__PURE__ */ jsxs20("div", { className: "lg:ml-auto flex-wrap flex items-center gap-2", children: [
              /* @__PURE__ */ jsxs20("span", { className: " text-left text-xs text-gray-500", children: [
                'Url: "',
                pathToOpen,
                '"'
              ] }),
          ...
          /* @__PURE__ */ jsx36(AccordionContent, { children: /* @__PURE__ */ jsx36(RouteInfo, { openNewRoute, route }) })
        ] }, route.id);
      })
    ] })
  ] });
...
var Stack = ({ gap = "md", className, children, ...props }) => {
  return /* @__PURE__ */ jsx37("div", { className: clsx13("flex flex-col", GAPS[gap], className), ...props, children });
};
...
var SelectTrigger = React5.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs21(
  SelectPrimitive.Trigger,
  {
    ...
    children: [
      children,
      /* @__PURE__ */ jsx38(SelectPrimitive.Icon, { asChild: true, children: /* @__PURE__ */ jsx38(Icon, { name: "ChevronDown", className: "h-4 w-4 opacity-50" }) })
    ]
  }
));
SelectTrigger.displayName = SelectPrimitive.Trigger.displayName;
var SelectContent = React5.forwardRef(({ className, children, position = "popper", ...props }, ref) => {
  return /* @__PURE__ */ jsx38(SelectPrimitive.Portal, { itemRef: "ref", className: "remix-dev-tools", children: /* @__PURE__ */ jsx38(
...
var SelectLabel = React5.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx38(SelectPrimitive.Label, { ref, className: cn("py-1.5 pl-8 pr-2 font-sans text-sm", className), ...props }));
SelectLabel.displayName = SelectPrimitive.Label.displayName;
var SelectItem = React5.forwardRef(({ className, children, ...props }, ref) => /* @__PURE__ */ jsxs21(
  SelectPrimitive.Item,
  {
    ...
    ...props,
    children: [
      /* @__PURE__ */ jsx38("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center", children: /* @__PURE__ */ jsx38(SelectPrimitive.ItemIndicator, { children: /* @__PURE__ */ jsx38(Icon, { name: "Check", className: "h-4 w-4" }) }) }),
      /* @__PURE__ */ jsx38(SelectPrimitive.ItemText, { children })
    ]
  }
));
SelectItem.displayName = SelectPrimitive.Item.displayName;
var SelectSeparator = React5.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx38(SelectPrimitive.Separator, { ref, className: cn("bg-grey-600 -mx-1 my-1 h-px", className), ...props }));
...
var SelectWithOptions = ({
  ...
  return /* @__PURE__ */ jsxs21(Stack, { className, gap: "sm", children: [
    ...
    /* @__PURE__ */ jsxs21(
      Select,
      {
        ...
        children: [
          /* @__PURE__ */ jsx38(SelectTrigger, { className: "w-full text-white", children: /* @__PURE__ */ jsx38(SelectValue, { placeholder }) }),
          /* @__PURE__ */ jsx38(SelectContent, { children: /* @__PURE__ */ jsxs21(SelectGroup, { children: [
            /* @__PURE__ */ jsx38(SelectLabel, { children: label }),
            options.map((option) => /* @__PURE__ */ jsx38(SelectItem, { value: option.value, children: option.label }, option.value))
          ] }) })
        ]
      }
    ),
...
var SettingsTab = () => {
  const { settings, setSettings } = useSettingsContext();
  const [minHeight, setMinHeight] = useState8(settings.minHeight.toString());
  const [maxHeight, setMaxHeight] = useState8(settings.maxHeight.toString());
  const [expansionLevel, setExpansionLevel] = useState8(settings.expansionLevel.toString());
  const [openHotkey, setOpenHotkey] = useState8(settings.openHotkey.toString());
  return /* @__PURE__ */ jsxs22(Stack, { className: "mb-4", children: [
    /* @__PURE__ */ jsxs22("h1", { children: [
      /* @__PURE__ */ jsx39("span", { className: "text-lg font-semibold", children: "Settings" }),
      /* @__PURE__ */ jsx39("hr", { className: "mt-2 border-gray-400" })
    ] }),
    /* @__PURE__ */ jsx39(
      Checkbox,
      {
    ...
    /* @__PURE__ */ jsx39("hr", { className: "mt-2 border-gray-700" }),
    /* @__PURE__ */ jsxs22(Stack, { gap: "lg", children: [
      settings.requireUrlFlag && /* @__PURE__ */ jsx39(
        Input,
        {
          name: "urlFlag",
          id: "urlFlag",
      ...
      /* @__PURE__ */ jsxs22("div", { className: "flex flex-col gap-2 lg:flex-row", children: [
        /* @__PURE__ */ jsx39(
          Input,
          {
            name: "minHeight",
...
import { useEffect as useEffect15, useRef as useRef8, useState as useState10 } from "react";
import clsx14 from "clsx";

// src/client/hooks/useTerminalShortcuts.ts
...
var useTerminalShortcuts = ({
  ...
  const [historyIndex, setHistoryIndex] = useState9();
  const [projectCommandIndex, setProjectCommandIndex] = useState9();
...
var Terminal = ({ onClose, terminal, projectCommands }) => {
  ...
  const [command, setCommand] = useState10("");
...
`
  ...
  return /* @__PURE__ */ jsxs23("div", { className: "relative flex h-full w-full flex-col justify-between rounded-lg border border-gray-100/10", children: [
    terminals.length > 1 && /* @__PURE__ */ jsx40(
      "button",
      {
        type: "button",
        onClick: () => {
        ...
        children: /* @__PURE__ */ jsx40(Icon, { name: "X", className: "h-6 w-6 stroke-red-500" })
      }
    ),
    /* @__PURE__ */ jsx40("div", { ref, className: "overflow-y-auto p-2", children: terminal.output?.map((output, i) => /* @__PURE__ */ jsx40(
      "div",
      {
        className: clsx14(
          "px-2",
    ...
    /* @__PURE__ */ jsxs23("div", { className: "border-3 relative flex rounded-xl border-gray-100", children: [
      /* @__PURE__ */ jsx40(
        "input",
        {
      ...
      /* @__PURE__ */ jsx40(
        "button",
        {
          ...
          children: /* @__PURE__ */ jsx40(Icon, { name: "Send", className: "h-4 w-4 stroke-white" })
        }
      )
    ] })
  ] });
...
var TerminalTab = () => {
  ...
  const [projectCommands, setProjectCommands] = useState10();
  const { sendJsonMessage } = useRemixForgeSocket({
    onMessage: (message) => {
      try {
        const data = JSON.parse(message.data);
  ...
  return /* @__PURE__ */ jsxs23("div", { className: "relative mr-8 flex h-full justify-between gap-4 rounded-lg", children: [
    terminals.length < 3 && /* @__PURE__ */ jsx40("button", { type: "button", className: "absolute -right-8", onClick: () => addOrRemoveTerminal(), children: /* @__PURE__ */ jsx40(Icon, { name: "Columns" }) }),
    terminals.map((terminal) => /* @__PURE__ */ jsx40(
      Terminal,
      {
        terminal,
        projectCommands,
...
var tabs = [
  {
    name: "Active page",
    icon: /* @__PURE__ */ jsx41(Icon, { size: "md", name: "Layers" }),
    id: "page",
    component: /* @__PURE__ */ jsx41(PageTab, {}),
    requiresForge: false,
    hideTimeline: false
  },
  {
    name: "Routes",
    icon: /* @__PURE__ */ jsx41(Icon, { size: "md", name: "GitMerge" }),
    id: "routes",
    component: /* @__PURE__ */ jsx41(RoutesTab, {}),
    requiresForge: false,
    hideTimeline: false
  },
  {
    name: "Terminal",
    icon: /* @__PURE__ */ jsx41(Icon, { size: "md", name: "Terminal" }),
    id: "terminal",
    component: /* @__PURE__ */ jsx41(TerminalTab, {}),
    requiresForge: true,
    hideTimeline: false
  },
  {
    name: "Errors",
    icon: /* @__PURE__ */ jsx41(Icon, { size: "md", name: "Shield" }),
    id: "errors",
    component: /* @__PURE__ */ jsx41(ErrorsTab, {}),
    requiresForge: false,
    hideTimeline: false
  },
  {
    name: "Settings",
    icon: /* @__PURE__ */ jsx41(Icon, { size: "md", name: "Settings" }),
    id: "settings",
    component: /* @__PURE__ */ jsx41(SettingsTab, {}),
    requiresForge: false,
    hideTimeline: false
  }
];
...
var RedirectEventComponent = (event) => {
  return /* @__PURE__ */ jsxs24("div", { className: "mb-4", children: [
    /* @__PURE__ */ jsxs24("time", { className: "mb-2 block text-sm font-normal leading-none text-gray-500", children: [
      'Navigated to url: "',
      event.to + event.search,
      '"'
    ] }),
    /* @__PURE__ */ jsx42("p", { className: "mb-4 text-base font-normal text-gray-400", children: event.hash }),
    event.responseData && /* @__PURE__ */ jsxs24("p", { className: "mb-4 text-base font-normal text-gray-400", children: [
      "Data received:",
      /* @__PURE__ */ jsx42(JsonRenderer, { data: event.responseData })
    ] })
  ] });
};
var FormEventComponent = (event) => {
  ...
  return /* @__PURE__ */ jsxs24("div", { className: "mb-4", children: [
    ...
    /* @__PURE__ */ jsxs24("div", { className: "flex gap-8", children: [
      event.data && event.type !== "ACTION_RESPONSE" && /* @__PURE__ */ jsxs24("div", { className: "mb-4 truncate text-base font-normal text-gray-400", children: [
        "Data sent:",
        /* @__PURE__ */ jsx42(JsonRenderer, { data: event.data })
      ] }),
      responseData && /* @__PURE__ */ jsxs24("div", { className: "mb-4 truncate text-base font-normal text-gray-400", children: [
        "Server Response Data:",
        /* @__PURE__ */ jsx42(JsonRenderer, { data: responseData })
      ] })
    ] })
  ] });
};
...
var TimelineTab = () => {
  ...
  return /* @__PURE__ */ jsxs24("div", { className: "relative flex h-full flex-col overflow-y-auto p-6 px-6", children: [
    timeline.length > 0 && /* @__PURE__ */ jsx42(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsx42("ol", { className: "relative", children: timeline.map((event) => {
      return /* @__PURE__ */ jsxs24("li", { className: "mb-2 ml-8 animate-fade-in-left", children: [
        /* @__PURE__ */ jsx42("span", { className: "absolute -left-3 mt-2 flex h-6 w-6 animate-fade-in items-center justify-center rounded-full bg-blue-900 ring-4 ring-blue-900", children: /* @__PURE__ */ jsx42(Icon, { name: "Activity" }) }),
        /* @__PURE__ */ jsxs24("h3", { className: "-mt-3 mb-1 flex items-center gap-2 text-lg font-semibold text-white", children: [
          Translations[event.type],
          event?.method && /* @__PURE__ */ jsx42(Tag, { color: METHOD_COLORS[event.method], children: event.method })
        ] }),
        event.type === "REDIRECT" || event.type === "FETCHER_REDIRECT" ? /* @__PURE__ */ jsx42(RedirectEventComponent, { ...event }) : /* @__PURE__ */ jsx42(FormEventComponent, { ...event })
      ] }, event.id);
    }) })
  ] });
};
...
var ContentPanel = ({ plugins }) => {
  ...
  return /* @__PURE__ */ jsxs25("div", { className: "flex h-full w-full overflow-y-hidden", children: [
    /* @__PURE__ */ jsx43(
      "div",
      {
        className: clsx15(
    ...
    !hideTimeline && /* @__PURE__ */ jsxs25(Fragment6, { children: [
      /* @__PURE__ */ jsx43("div", { className: "w-1 bg-gray-500/20" }),
      /* @__PURE__ */ jsx43("div", { className: clsx15("z-10 hidden lg:block h-full w-1/3 p-2"), children: /* @__PURE__ */ jsx43(TimelineTab, {}) })
    ] })
  ] });
};
...
import { useCallback as useCallback4, useEffect as useEffect17, useState as useState11 } from "react";
var useResize = () => {
  const { setSettings, settings } = useSettingsContext();
  const { height, maxHeight, minHeight, panelLocation } = settings;
  const [isResizing, setIsResizing] = useState11(false);
  const enableResize = useCallback4(() => {
    setIsResizing(true);
  }, [setIsResizing]);
  const disableResize = useCallback4(() => {
    setIsResizing(false);
  }, [setIsResizing]);
  const resize = useCallback4(
    (e) => {
      if (isResizing) {
...
var useResizeDetachedPanel = () => {
  ...
  const [state, setState] = useState12(0);
...
var MainPanel = ({ children, isOpen, isEmbedded = false, className }) => {
  ...
  return /* @__PURE__ */ jsxs26(
    "div",
    {
      ...
      children: [
        panelLocation === "bottom" && /* @__PURE__ */ jsx44(
          "div",
          {
            onMouseDown: enableResize,
            onMouseUp: disableResize,
            className: clsx16("absolute z-50 h-1 w-full", isResizing ? "cursor-grabbing" : "cursor-ns-resize")
          }
        ),
        children,
        panelLocation === "top" && /* @__PURE__ */ jsx44(
          "div",
          {
            onMouseDown: enableResize,
            onMouseUp: disableResize,
            className: clsx16("absolute bottom-0 z-50 h-1 w-full", isResizing ? "cursor-grabbing" : "cursor-ns-resize")
          }
        )
      ]
    }
  ...
  return (
    ...
    /* @__PURE__ */ jsxs27(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx45("div", { className: clsx17(className, "group-hover:opacity-80 transition-all"), children: tab.icon }),
          /* @__PURE__ */ jsx45(
            "div",
            {
              className: clsx17(
...
var Tabs = ({ plugins, setIsOpen }) => {
  ...
  return /* @__PURE__ */ jsx45("div", { className: "relative flex h-full bg-gray-800", children: /* @__PURE__ */ jsxs27("div", { ref: scrollRef, className: "remix-dev-tools-tab  flex h-full w-full flex-col", children: [
    visibleTabs.map((tab) => /* @__PURE__ */ jsx45(
      Tab,
      {
        tab: {
          ...tab,
    ...
    /* @__PURE__ */ jsx45("div", { className: clsx17("mt-auto flex w-full flex-col items-center"), children: !detachedWindow && setIsOpen && /* @__PURE__ */ jsxs27(Fragment7, { children: [
      !detachedWindowOwner && /* @__PURE__ */ jsx45(
        Tab,
        {
          className: "transition-all hover:text-green-600",
          tab: {
            icon: /* @__PURE__ */ jsx45(Icon, { name: "CopySlash", size: "md", onClick: handleDetachment }),
            id: "detach",
            name: "Detach",
            requiresForge: false,
            hideTimeline: false,
            component: /* @__PURE__ */ jsx45(Fragment7, {})
          }
        }
      ),
      /* @__PURE__ */ jsx45(
        Tab,
        {
          ...
          tab: {
            icon: /* @__PURE__ */ jsx45(Icon, { name: "X", size: "md" }),
            id: "close",
            name: "Close",
            requiresForge: false,
            hideTimeline: false,
...
var Embedded = ({ plugins: pluginArray, mainPanelClassName, className }) => {
  ...
  if (settings.requireUrlFlag && !url.includes(settings.urlFlag))
    return null;
  return /* @__PURE__ */ jsx46("div", { id: REMIX_DEV_TOOLS, className: clsx18("remix-dev-tools remix-dev-tools-reset", className), children: /* @__PURE__ */ jsxs28(MainPanel, { className: mainPanelClassName, isEmbedded: true, isOpen: true, children: [
    /* @__PURE__ */ jsx46(Tabs, { plugins }),
    /* @__PURE__ */ jsx46(ContentPanel, { leftSideOriented, plugins })
  ] }) });
};
var hydrating = true;
function useHydrated() {
  const [hydrated, setHydrated] = useState13(() => !hydrating);
  useEffect19(function hydrate() {
    hydrating = false;
    setHydrated(true);
  }, []);
  return hydrated;
...
var EmbeddedDevTools = ({ plugins, mainPanelClassName, className }) => {
  ...
  if (!hydrated)
    return null;
  return /* @__PURE__ */ jsx46(RDTContextProvider, { children: /* @__PURE__ */ jsx46(Embedded, { mainPanelClassName, className, plugins }) });
};
...
import { Link as Link2, useLocation as useLocation3 } from "@remix-run/react";
...
var Logo = ({ className, style }) => {
  return /* @__PURE__ */ jsxs29(
    "svg",
    {
      ...
      children: [
        /* @__PURE__ */ jsx47("title", { children: "Logo" }),
        /* @__PURE__ */ jsx47("rect", { width: "800", height: "800", fill: "#212121" }),
        /* @__PURE__ */ jsx47(
          "path",
          {
            fillRule: "evenodd",
        ...
        /* @__PURE__ */ jsx47("path", { d: "M195 636V562.553H328.697C351.029 562.553 355.878 579.116 355.878 588.994V636H195Z", fill: "white" }),
        /* @__PURE__ */ jsx47(
          "path",
          {
...
import { useCallback as useCallback5, useContext as useContext8, useEffect as useEffect20, useState as useState14 } from "react";
var useCheckIfStillDetached = () => {
  const { dispatch } = useContext8(RDTContext);
...
var LiveUrls = () => {
  ...
  if (settings.liveUrls.length === 0)
    return null;
  return /* @__PURE__ */ jsx49("div", { className: clsx20("flex fixed items-center z-[9998] gap-2 px-2", envsClassName), children: settings.liveUrls.map((env) => {
...
var DevTools = ({ plugins: pluginArray }) => {
  ...
  const { position } = settings;
  const [isOpen, setIsOpen] = useState15(isDetached || settings.defaultOpen || persistOpen);
  const leftSideOriented = position.includes("left");
  const plugins = pluginArray?.map((plugin) => typeof plugin === "function" ? plugin() : plugin);
  ...
  if (detachedWindowOwner) {
    return /* @__PURE__ */ jsx49("div", { id: REMIX_DEV_TOOLS, className: "remix-dev-tools remix-dev-tools-reset", children: /* @__PURE__ */ jsx49(
      Trigger3,
      {
        isOpen: false,
        setIsOpen: () => {
  ...
  return /* @__PURE__ */ jsxs30("div", { id: REMIX_DEV_TOOLS, className: "remix-dev-tools remix-dev-tools-reset", children: [
    /* @__PURE__ */ jsx49(Trigger3, { isOpen, setIsOpen }),
    /* @__PURE__ */ jsx49(LiveUrls, {}),
    /* @__PURE__ */ jsx49(Breakpoints, {}),
    /* @__PURE__ */ jsx49(MainPanel, { isOpen, children: /* @__PURE__ */ jsxs30("div", { className: "flex h-full", children: [
      /* @__PURE__ */ jsx49(Tabs, { plugins, setIsOpen }),
      /* @__PURE__ */ jsx49(ContentPanel, { leftSideOriented, plugins })
    ] }) })
  ] });
};
var RemixDevTools = ({ plugins, config }) => {
  return /* @__PURE__ */ jsx49(RDTContextProvider, { config, children: /* @__PURE__ */ jsx49(DevTools, { plugins }) });
};
...
// src/client/init/root.tsx
import { Fragment as Fragment8, jsx as jsx50, jsxs as jsxs31 } from "react/jsx-runtime";
var hydrating2 = true;
function useHydrated2() {
  const [hydrated, setHydrated] = useState16(() => !hydrating2);
...
var withDevTools = (Component, config) => () => {
  ...
  if (!hydrated)
    return /* @__PURE__ */ jsx50(Component, {});
  return /* @__PURE__ */ jsxs31(Fragment8, { children: [
    /* @__PURE__ */ jsx50(Component, {}),
    createPortal(/* @__PURE__ */ jsx50(RemixDevTools, { ...config }), document.body)
  ] });
};
var withViteDevTools = (Component, config) => () => {
  hydrationDetector();
  function AppWithDevTools(props) {
    const hydrated = useHydrated2();
    if (!hydrated)
      return /* @__PURE__ */ jsx50(Component, {});
    return /* @__PURE__ */ jsxs31(Fragment8, { children: [
      /* @__PURE__ */ jsx50(Component, { ...props }),
      createPortal(/* @__PURE__ */ jsx50(RemixDevTools, { ...config }), document.body)
    ] });
  }
...
export {
  EmbeddedDevTools,
  defineClientConfig,
  useRemixForgeSocketExternal as useRemixForgeSocket,
  withDevTools,
  withViteDevTools
};
