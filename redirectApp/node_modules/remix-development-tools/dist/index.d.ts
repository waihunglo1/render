...
declare const defineRdtConfig: (config: RemixViteConfig) => RemixViteConfig;
declare const remixDevTools: (args?: RemixViteConfig) => Plugin[];
...
export { EmbeddedDevToolsProps, RdtPlugin, RemixDevToolsProps, defineRdtConfig, remixDevTools };
